...
const Cart = () => {
  ...
  // Function to handle the payment and show the success message
  const handlePayment = () => {
    // Implement your payment processing logic here.
    // Assuming paymentSuccess is set to true if payment is successful.
    // You can replace this simulated logic with your actual payment processing logic.
    // For this example, we'll just simulate success after a brief delay.
    setTimeout(() => {
    ...
    <div>
      ...
      {cart.length === 0 ? (
        <div className="text-center">
          <img src="image/nodatafound.png" alt="No data found" />
        </div>
      ) : (
        <div className="grid">
              ...
              <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title text-dark h4" id="staticBackdropLabel">
                      Payment details
                    </h5>
                    <button
                      type="button"
                    ...
                    <form className="row g-3 needs-validation" noValidate>
                      <div className="col-md-12">
                        ...
                        <input
                          ...
                          required
                        />
                        <div className="valid-feedback">Please provide Card Holder's Name.</div>
                      </div>
                      <div className="col-md-12">
                        ...
                        <input
                          ...
                          required
                        />
                        <div className="invalid-feedback">Please provide a valid Card No.</div>
                      </div>
                      ...
                      <div className="col-md-4">
                        ...
                        <input
                          ...
                          required
                        />
                        <div className="invalid-feedback">Please provide a valid CVV.</div>
                      </div>
